...
# ABSTRACT: ::RewriteVersion but force normalising ENV{V} and other sources.
...
Dist::Zilla::Plugin::RewriteVersion::Sanitized - ::RewriteVersion but force normalising ENV{V} and other sources.
